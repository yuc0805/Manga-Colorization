...
# python train.py --dataroot colorization_dataset --name color_pix2pix --model colorization --dataset_mode colorization --model colorization --input_nc 1 --output_nc 2 --n_epochs 160000